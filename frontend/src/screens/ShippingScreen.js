...
const ShippingScreen = ({ history }) => {
  ...
  const [country, setCountry] = useState(shippingAddress.country || 'México')
  ...
  const submitHandler = (e) => {
    e.preventDefault()
    dispatch(
      saveShippingAddress({ address, neighborhood, city, postalCode, country })
    )
      ...
      <Card>
        ...
        <FormContainer>
          <Card.Body>
            ...
            {country !== undefined && !country.includes('México') && (
              <>
                <br />
                <br />
